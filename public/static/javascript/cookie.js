var cookieconsent = (function(e) {
  ...
  function(e, n, t) {
    ...
    e.exports = function(e, n) {
      ...
      ((n = n || {}).attrs = "object" == typeof n.attrs ? n.attrs : {}),
        n.singleton || "boolean" == typeof n.singleton || (n.singleton = c()),
    ...
    function y(e, n, t, o) {
      ...
      if (e.styleSheet) e.styleSheet.cssText = b(n, i);
        ...
        c[n] && e.removeChild(c[n]),
          c.length ? e.insertBefore(r, c[n]) : e.appendChild(r);
      }
    }
  },
  function(e) {
  ...
  function(e, n, t) {
    ...
    var o = (function() {
        ...
        return (
          ...
          (e.getCookie = function(e) {
            for (
              var n = e + "=", t = document.cookie.split(";"), o = 0;
              o < t.length;
              o++
            ) {
    ...
    var h,
        ...
        return (
          ...
          (e.prototype._noticeScriptIfValid = function(e) {
            ...
            o.searchObjectsArray(
              ...
              : this.cookieConsent.log(
                  "Invalid cookie consent level for javascript sript: " + n,
                  "warning"
                );
          }),
            ...
            for (var n in this.scripts[e]) {
              ...
              i.setAttribute("type", "text/javascript"),
                ...
                null !== t.getAttribute("src") &&
                  i.setAttribute("src", t.getAttribute("src")),
                (i.text = t.innerHTML),
                o.appendChild("head", i),
      ...
      b = (function() {
        ...
        return (
          ...
          (e.prototype.markUserAccepted = function() {
            (this.userAccepted = !0),
              !1 === this.cookieConsent.isDemo &&
                o.setCookie(this.consentAcceptedCookieName, "true");
          }),
          ...
          (e.prototype.loadAcceptedCookies = function() {
            for (var e in this.cookieConsent.cookieLevels.cookieLevels) {
              ...
              !1 !== this.acceptedLevels[n] &&
                this.cookieConsent.javascriptItems.enableScriptsByLevel(n);
            }
          }),
          ...
          (e.prototype.saveCookie = function() {
            ...
            return (
              o.setCookie(this.consentLevelCookieName, e),
              this.cookieConsent.log(
      ...
      y = function() {
        (this.cc_dialogShown = o.registerEvent("cc_dialogShown")),
          (this.cc_dialogOkPressed = o.registerEvent("cc_dialogOkPressed")),
          (this.cc_dialogPreferencesPressed = o.registerEvent(
            "cc_dialogPreferencesPressed"
          )),
          (this.cc_userLanguageChanged = o.registerEvent(
            "cc_userLanguageChanged"
          )),
          (this.cc_preferencesSavePressed = o.registerEvent(
          ...
          (e.prototype.cc_dialogOkPressed = function() {
            ...
            document.addEventListener("cc_dialogOkPressed", function() {
              e.cookieConsent.log("cc_dialogOkPressed triggered", "event"),
                e.cookieConsent.consentType instanceof P
        ...
        return (
            ...
            t &&
              t.addEventListener("click", function() {
                document.dispatchEvent(
                  n.cookieConsent.events.cc_dialogPreferencesPressed
                ),
                  n.showPreferences();
              });
          }),
          (e.prototype.showPreferences = function() {
            null === this.cpOverlay &&
              ...
              o.appendChild("body", this.cpOverlay)),
          ...
          (e.prototype.createPreferencesOverlayAndDialog = function() {
            ...
            if (
              ...
              (c.innerText = this.cookieConsent.ownerWebsiteName),
                o.appendChild(r, c);
            }
            var a = document.createElement("h2");
            (a.innerHTML = this.cookieConsent.i18n.$t(
              "preference_center",
              "title"
            )),
              o.appendChild(r, a);
          ...
          (e.prototype.obtainLanguageSelector = function() {
            ...
            return (
              [].forEach.call(e.cookieConsent.i18n.availableLanguages, function(
                t
              ) {
          ...
          (e.prototype.getContentContainer = function() {
            ...
            return (
              e.cookieConsent.cookieLevels.preferenceItems.forEach(function(i) {
                var r = document.createElement("div");
                if (
                  (r.classList.add("cc_cp_m_content_entry"),
                  r.setAttribute("content_layout", i.content_container),
                  r.setAttribute("active", "false"),
                  (r.innerHTML = i.content),
                  0 === t && r.setAttribute("active", "true"),
                  t++,
                  i.id)
                ) {
          ...
          (e.prototype.getMenuContainer = function() {
            ...
            return (
              e.cookieConsent.cookieLevels.preferenceItems.forEach(function(i) {
                ...
                c.setAttribute("href", "#"),
                  c.setAttribute("t", i.content_container),
                  (c.innerHTML = i.title),
                  0 === t && r.setAttribute("active", "true"),
                  t++,
                  c.addEventListener("click", function(n) {
                    n.preventDefault(),
                      e.cookieConsent.log(
                        "Preferences menu item clicked: " + i.title,
                        "info"
                      );
                    ...
                    try {
                      ...
                      [].forEach.call(o, function(e) {
                        ...
                        document
                          .querySelector(
                            'div[content_layout="' + i.content_container + '"]'
                          )
          ...
          (e.prototype.getContainer = function() {
            ...
            var t = document.createElement("div");
            t.classList.add("p"),
              (t.innerHTML = o.magicTransform(
                "R0RQUiBDb29raWUgQ29uc2VudCBieSA8YSBocmVmPSJodHRwczovL3d3dy5wcml2YWN5cG9saWNpZXMuY29tL2Nvb2tpZS1jb25zZW50LyIgdGFyZ2V0PSJfYmxhbmsiPlByaXZhY3lQb2xpY2llcy5jb208L2E+"
              ));
            var i = document.createElement("div");
          ...
          (e.prototype._getLevelCheckbox = function(e) {
            ...
            if ("strictly-necessary" !== e.id) {
              ...
              r.setAttribute("cookie_consent_toggler", "true"),
                ...
                (c = document.createElement("label")).setAttribute("for", e.id),
                i[e.id]
                  ? (r.setAttribute("checked", "checked"),
                    c.setAttribute("class", "is-active"),
                    (c.innerHTML = n.cookieConsent.i18n.$t("dialog", "active")))
                  : (c.setAttribute("class", "is-inactive"),
                    (c.innerHTML = n.cookieConsent.i18n.$t(
                      "dialog",
                      "inactive"
                    ))),
                r.addEventListener("change", function() {
                  ...
                  n.cookieConsent.log(
                    ...
                    document.dispatchEvent(
                      n.cookieConsent.events.cc_userChangedConsent
                    ),
                    !0 === t
                      ? (n.cookieConsent.userConsent.acceptLevel(o),
                        (i.innerHTML = n.cookieConsent.i18n.$t(
                          "dialog",
                          "active"
                        )))
                      : (n.cookieConsent.userConsent.rejectLevel(o),
                        (i.innerHTML = n.cookieConsent.i18n.$t(
                          "dialog",
                          "inactive"
                        )));
        ...
        return (
          (e.prototype.initDialog = function() {
            return (
              ...
              o.appendChild("body", this.dialog, "afterbegin"),
          ...
          (e.prototype.createDialog = function() {
            ...
            if (
              (o.appendChild(e, this.createDialogContent()),
          ...
          (e.prototype.createDialogContent = function() {
            ...
            r.classList.add("cc_dialog_text"),
              (r.innerHTML = e.cookieConsent.i18n.$t("dialog", "text")),
              o.appendChild(i, r);
            var c = document.createElement("button");
            c.classList.add("cc_b_ok"),
              "express" == e.cookieConsent.userConsentType
                ? (c.innerHTML = e.cookieConsent.i18n.$t(
                    "dialog",
                    "i_agree_text"
                  ))
                : (c.innerHTML = e.cookieConsent.i18n.$t("dialog", "ok_text")),
      ...
      j = (function(e) {
        function n(n) {
          ...
          return (
            t.dialogExtraCss.push("simple"),
            t.dialogExtraCss.push("px-5"),
            t.dialogExtraCss.push("py-5"),
            t
          );
        }
        return _(n, e), n;
      ...
      L = (function(e) {
        function n(n) {
          var t = e.call(this, n) || this;
          return (
            t.dialogExtraCss.push("headline"),
            t.dialogExtraCss.push("px-5"),
            t.dialogExtraCss.push("py-5"),
            t
          );
      ...
      E = (function(e) {
        function n(n) {
          var t = e.call(this, n) || this;
          return (
            t.dialogExtraCss.push("interstitial"),
            t.dialogExtraCss.push("px-5"),
            t.dialogExtraCss.push("py-5"),
            t
          );
      ...
      S = (function(e) {
        function n(n) {
          var t = e.call(this, n) || this;
          return (
            t.dialogExtraCss.push("standalone"),
            t.dialogExtraCss.push("px-5"),
            t.dialogExtraCss.push("py-5"),
            t
          );
      ...
      D = (function() {
        function e(e) {
          switch (
            ...
            (this.ownerSiteLanguage = e.language || "de"),
          ...
          (this.events = new y()),
            ...
            (this.i18n = new g(this)),
            (this.cookieLevels = new z(this)),
            (this.userConsent = new b(this)),
            (this.javascriptItems = new v(this)),
            (this.consentPreferences = new C(this)),
